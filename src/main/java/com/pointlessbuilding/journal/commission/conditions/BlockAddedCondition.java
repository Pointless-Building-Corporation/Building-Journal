...
public class BlockAddedCondition implements CommissionCondition{
    ...
    public BlockAddedCondition(String title, String failureDescription, List<ResourceLocation> blocks, Operator operator, long threshold) {
        this.title = title;
    ...
    public String describeFailure(EvaluationResult result) {
        if(failureDescription == null) {
            String generatedDesc = "Added blocks not ";
             switch (operator) {
    ...
    public static CommissionCondition fromJson(JsonObject json) {
        ...
        if(json.has("blocks")) {
            ...
            for (JsonElement block : blockArray) {
                ...
                if(blockString.startsWith("#")) {   // Tag
                    ...
                    if(tagId == null) {
                        BuildingJournal.LOGGER.error("Invalid tag resource location in commission blocks list of {}", jsonTitle != null ? jsonTitle : "BlockAddedCondition");
                        continue;
                    }
                    ...
                    if(parsed == null) {
                        BuildingJournal.LOGGER.error("Invalid block resource location in commission blocks list of {}", jsonTitle != null ? jsonTitle : "BlockAddedCondition");
                        continue;
                    }
        ...
        if(json.has("operator")) {
            ...
            BuildingJournal.LOGGER.warn("Missing operator field in condition {}", jsonTitle != null ? jsonTitle : "BlockAddedCondition");
            return null;
        }
        ...
        if(json.has("threshold")) {
            ...
            BuildingJournal.LOGGER.warn("Missing threshold field in condition {}", jsonTitle != null ? jsonTitle : "BlockAddedCondition");
            return null;
        }

        return new BlockAddedCondition(jsonTitle, jsonFailure, jsonBlocks, jsonOperator, jsonThreshold);
    }
